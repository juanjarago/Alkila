...
export const propertyDetails: Record<string, PropertyDetails> = {
  "cabana-privada-anapoima-8-personas": {
    moreInfo: [
      "Casa de recreo rodeada de naturaleza, pensada para descansar en familia y disfrutar el clima de Anapoima.",
      "Cuenta con 2 habitaciones, cada una con bano privado, aire acondicionado y acomodacion familiar.",
      "La zona social integra sala, comedor, BBQ, piscina/jacuzzi, arenera y bano social.",
      "La cocina es abierta y esta equipada con nevera, estufa a gas, licuadora, cafetera y menaje basico.",
    ],
    amenities: [
    ...
    rules: [
      ...
      "La pesca y personas adicionales se coordinan previamente y pueden tener costo adicional.",
    ],
  },
